...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc1.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc11.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc2.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc21.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc3.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc311.drawio.png}
...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
\subsubsection{UC3.2 - Visualizza lista degli ordini personali}
\begin{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
\subsubsection{UC3.2.1 - Visualizza in dettaglio lista degli ordini personali}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc322.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc333.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc4.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc41.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc42.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc111.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{usecase/tesi-uc5.drawio.png}

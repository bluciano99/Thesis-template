...
L'utente deve poter accedere nella sezione del menù visualizzando tutti i piatti oppure quelli filtrati. I piatti del menù possono essere visualizzati in modalità normale e dettagliata, gli utenti possono aggiungerli negli ordini. L'utente per inserire le portate negli ordini deve poter entrare in un sessione di tavolo creando o unendo, in ogni momento può uscire dalla sessione. Gli ordini devono essere visualizzati correttamente nella maschera degli ordini del tavolo, l'utente deve poter generare il QR-code a essi associati e spostarli nella lista degli ordini in arrivo, questa lista deve visualizzare tutti i piatti ordinati con la rispettiva descrizione e l'immagine. I piatti contenuti nella lista degli ordini in arrivo possono essere marcati come arrivato. L'utente deve poter registrarsi alla piattaforma , di seguito eseguire il login per accedere alla propria blacklist e modificarla. Nel caso di password dimenticata l'utente deve poter recuperare la password tramite l'email. 
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.6]{gestione del tavolo.png}
    \caption{Maschera gestione del tavolo SushiLab}
\end{figure}
\pagebreak
...
\begin{figure}[H]
    ...
    \caption{Maschera lista degli ordini del tavolo e QR-code ordini SushiLab}
\end{figure}
\pagebreak
